...
To know more about the use of Alastria Network, you can visit the following Smart Contract Deployment Guides:
* [Deploying to Alastria's Red T (Quorum)](https://github.com/rogargon/copyrightly.io/blob/master/docs/NetworkT.md) created by Roberto Garcia, from Lleida University
